...
from .model import make_attn, my_group_norm, nonlinearity, Normalize, get_timestep_embedding
...
class SIGEDownsample(SIGEModule):
    def __init__(self, in_channels, with_conv, block_size: int = 6):
        ...
        self.conv = SIGEConv2d(in_channels, in_channels, kernel_size=3, stride=2, padding=0)
